    ...
    return (
        <section className="what-do-container">
            <Container className="py-5 ">
                ...
                <p className="d-none d-md-block text-center text-secondary">
                    Our main focus is to make the User Experience very <br />
                simple and easy. Simplicity is our Strength.
            </p>
                <p className="px-4 d-block d-md-none text-center text-secondary">
                    Our main focus is to make the User Experience very
                    simple and easy. Simplicity is our Strength.
            </p>
                <div className="row mt-5">
                    <div className="col-md-3 mb-4">
                        <div className="what-we-do-card p-4 py-5 text-center">
